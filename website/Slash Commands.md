Slash commands are quick ways to perform repetitive tasks. 99% of the time this will mean using a [[^Library/Std/Slash Templates]], but you can also create them more manually using [[Space Lua#Slash commands]].
