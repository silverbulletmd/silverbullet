...
tag.define {
  ...
  schema = {
    ...
    properties = {
      ...
      owner = { type = "string", description = "Who maintains this ADR — a contributor page link; surfaced in [[Maintenance]]." },
      lastReviewed = { type = "string", description = "Date this ADR was last reviewed (YYYY-MM-DD); powers the [[Maintenance]] freshness view." },
