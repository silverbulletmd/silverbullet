Slash commands are quick ways to perform repetitive tasks. 99% of the time this will mean using a [[^Library/Std/Infrastructure/Slash Templates]], but you can also create them in a more low-level way using [[Space Lua#Slash commands]].
