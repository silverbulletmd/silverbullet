...
Deno.test("Collab server", async () => {
  ...
  assertEquals(collabServer.ping("client1", undefined, "page1"), {});
  assertEquals(collabServer.pages.size, 0);
  assertEquals(collabServer.ping("client1", "page1"), {});
  console.log("Client 1 joins page 2");
  assertEquals(collabServer.ping("client1", "page2", "page1"), {});
  assertEquals(collabServer.pages.size, 1);
  ...
  assertEquals(collabServer.ping("client2", "page1", "page2"), {});
  assertEquals(collabServer.ping("client1", "page2", "page2"), {});
