...
TEMPLATE_GRAMMAR=common/template_parser/template.grammar
...
deno run -A npm:@lezer/generator@$LEZER_GENERATOR_VERSION $TEMPLATE_GRAMMAR -o common/template_parser/parse-template.js