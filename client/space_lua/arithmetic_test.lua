...
assert_throws("attempt to add a 'string' with a 'number'",
  function()
    return 'x1'+1
  end
)
...
assert_throws('attempt to perform arithmetic on a table value',
  function()
    return -{}
  end
)
...
assert_throws("attempt to unm a 'string' with a 'string'",
  function()
    return -'x'
  end
)
