...
---
Attribute syntax can contribute additional [[Concept/Metadata]] to various [[Object|Objects]], including:

* Pages (although the preferred way is [[Concept/Frontmatter]])
...
Attribute names need to be alpha-numeric. Values are interpreted as [[Concept/YAML]] values. So here are some examples of valid attribute definitions:
...
However, usually, [[Concept/Frontmatter]] is used for this purpose instead.
