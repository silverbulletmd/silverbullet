...
They are often used in [[Feature/Slash Template]] and [[Concept/Page Template]].
...
# Page templates
[[Concept/Page Template|Page templates]] are pages tagged with `#meta/template/page`. They serve as blueprints for creating new pages — you can configure them with suggested names, keyboard shortcuts, and commands.

# Slash templates
[[Feature/Slash Template]] are pages tagged with `#meta/template/slash`. They define [[Concept/Slash Command|slash commands]] that insert templated content at the cursor position. The last component of the page name becomes the slash command name.

See also: [[API/template]], [[Concept/Page Template]], [[Feature/Slash Template]], [[Space Lua]]