...
SilverBullet uses [JSON Schema](https://json-schema.org) for validation of structured data. Schemas ensure that [[Concept/Frontmatter]] attributes, [[Concept/Tag#Custom tags|custom tag]] fields, and configuration options conform to expected types and shapes.
...
See also: [[Concept/Tag#Custom tags]], [[API/jsonschema]], [[API/config]]
