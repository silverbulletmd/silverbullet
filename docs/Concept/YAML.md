...
SilverBullet uses YAML in various contexts, specifically [[Concept/Frontmatter]].
...
However when you want to reference [[Concept/Link|a page]] you will need to quote the full link:
```yaml
some page: "[[Pages]]"
list of pages:
  - "[[Pages]]"
