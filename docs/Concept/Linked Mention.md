...
---
Linked mentions (also known as backlinks) show all pages that contain a [[Concept/Link|link]] to the current page. They appear as a “Linked Mentions” section that (by default) is docked at the bottom of every page that has incoming links.

# How?
SilverBullet's [[Concept/Object Index]] tracks all links between pages. The Linked Mentions view queries this index to find pages that link _to_ the page you're currently viewing, then displays them with a snippet of the surrounding context. 
