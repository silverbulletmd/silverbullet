...
# Slash templates
Most slash commands are implemented as [[Feature/Slash Template]] — pages tagged with `#meta/template/slash` whose content is inserted at the cursor. The standard library includes slash templates for:
...
1. **Slash templates** (recommended): Create a page tagged `#meta/template/slash`. See [[Feature/Slash Template]] for details.
