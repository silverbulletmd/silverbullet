...
- `Baked Sections: Unbake Section At Cursor` — put your cursor inside a baked section and run this to turn it back into a live `${...}` directive. Handy when you want to edit the expression with [[Feature/Live Preview]] again, bake it back when you’re done.
...
# Who is this for?
* **Sharing or publishing outside SilverBullet** ([[Feature/Share]], [[Concept/Export]]) — bake your dynamic pages so a published site, a GitHub repo, or a static export shows real tables and content instead of directive source.
