...
To open, run the command ${widgets.commandButton("Navigate: Anything Picker")} using this button or [[Command Palette]]. Alternatively reach it from any other picker with `Tab`: it is the **All** segment of the same [[View]].
