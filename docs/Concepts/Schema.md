...
SilverBullet uses [JSON Schema](https://json-schema.org) for validation of structured data. Schemas ensure that [[Concepts/Frontmatter]] attributes, [[Concepts/Tag#Custom tags|custom tag]] fields, and configuration options conform to expected types and shapes.
...
See also: [[Concepts/Tag#Custom tags]], [[API/jsonschema]], [[API/config]]
