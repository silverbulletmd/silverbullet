...
All commands available commands appear in the [[Features/Command Palette]] but may have key bindings as well (these key bindings appear in the [[Features/Command Palette]] and are configurable in [[Features/Configuration Manager]]).
