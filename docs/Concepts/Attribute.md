...
---
Attribute syntax can contribute additional [[Concepts/Metadata]] to various [[Object|Objects]], including:

* Pages (although the preferred way is [[Concepts/Frontmatter]])
...
Attribute names need to be alpha-numeric. Values are interpreted as [[Concepts/YAML]] values. So here are some examples of valid attribute definitions:
...
However, usually, [[Concepts/Frontmatter]] is used for this purpose instead.
