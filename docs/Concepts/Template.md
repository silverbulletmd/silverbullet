...
They are often used in [[Features/Slash Template]] and [[Concepts/Page Template]].
...
# Page templates
[[Concepts/Page Template|Page templates]] are pages tagged with `#meta/template/page`. They serve as blueprints for creating new pages — you can configure them with suggested names, keyboard shortcuts, and commands.

# Slash templates
[[Features/Slash Template]] are pages tagged with `#meta/template/slash`. They define [[Concepts/Slash Command|slash commands]] that insert templated content at the cursor position. The last component of the page name becomes the slash command name.

See also: [[API/template]], [[Concepts/Page Template]], [[Features/Slash Template]], [[Space Lua]]