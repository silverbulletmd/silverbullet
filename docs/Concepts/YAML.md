...
SilverBullet uses YAML in various contexts, specifically [[Concepts/Frontmatter]].
...
However when you want to reference [[Concepts/Link|a page]] you will need to quote the full link:
```yaml
some page: "[[Pages]]"
list of pages:
  - "[[Pages]]"
