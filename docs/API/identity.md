...
APIs to define [[Concepts/Identity|identities]] — the names you can address with `@name`, whether you're addressing them (see [[Concepts/Recipient]]) or crediting them (see [[Concepts/Authorship]]).
...
Both now complete after `@`, and mentions of them are collected in the [[Concepts/Recipient#The Mention Inbox|Mention Inbox]] like any other.
