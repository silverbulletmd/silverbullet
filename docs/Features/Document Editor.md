...
# Available editors
Currently only two major document editors exist (As well as the built-in image viewer). Both are installable through the [[Features/Configuration Manager#Libraries|Library Manager]].
