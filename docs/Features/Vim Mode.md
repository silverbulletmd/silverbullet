...
SilverBullet [[Concepts/Command]] bindings take precedence over Vim bindings, you may wish to update or disable some [[Concepts/Keyboard Shortcuts]] or remap the desired functionality in Vim as shown below.
