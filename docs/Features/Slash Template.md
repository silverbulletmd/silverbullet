...
---
Slash templates are a quick way to define [[Concepts/Slash Command|slash commands]] that insert templated content at the cursor position. They are defined as pages tagged with `#meta/template/slash`.
...
# Configuration
You can configure these optional [[Concepts/Frontmatter]] keys:
...
See also: [[Concepts/Slash Command]], [[Concepts/Template]], [[Concepts/Page Template]]
