...
* By changing the page name and hitting `Enter` (or clicking/tapping outside of it) you **rename** the [[Concepts/Page|page]], automatically updating all references to it as well.