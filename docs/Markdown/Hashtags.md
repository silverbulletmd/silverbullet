...
Hashtag syntax (`#my-tag`) can be used to explicitly assign a [[Concepts/Tag]] to an [[Object]].
...
* If a hashtag is used inside of a [[Concepts/Task]], it applies to that **task**.
