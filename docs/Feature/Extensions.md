...
# Libraries
[[Concept/Library|Libraries]] are collections of [[Space Lua]] scripts, templates, and pages that you can install into your space via the [[Feature/Configuration Manager#Libraries|Library Manager]]. They are the primary extension mechanism and the easiest way to add new features. Libraries can define:

* Custom [[Concept/Command|commands]]
* [[Feature/Slash Template]]
* [[Concept/Page Template|Page templates]]
* [[API/widget|Widgets]]
* [[Concept/Space Style]] customizations
* [[Feature/Virtual Pages]]

Libraries are distributed as SilverBullet spaces themselves (typically via Git repositories), and managed through the [[Feature/Configuration Manager#Libraries|Library Manager]].
