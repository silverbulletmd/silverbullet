...
---
A single SilverBullet server can host any number of [[Concept/Space|spaces]] — each with its own URL, access rules, and configuration — managed a web-based management UI called _Space Manager_.
