...
---
Slash templates are a quick way to define [[Concept/Slash Command|slash commands]] that insert templated content at the cursor position. They are defined as pages tagged with `#meta/template/slash`.
...
# Configuration
You can configure these optional [[Concept/Frontmatter]] keys:
...
See also: [[Concept/Slash Command]], [[Concept/Template]], [[Concept/Page Template]]
