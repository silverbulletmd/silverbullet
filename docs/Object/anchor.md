...
---
Every [[Markdown/Anchor]] (`$name`) defined in your [[Concepts/Space]] also produces a small `anchor`-tagged object that maps the anchor name to the host object's location.
