...
Make a page called "Website Redesign" with structured [[Concepts/Frontmatter]]:
...
Add metadata to tasks using [[Concepts/Attribute]] syntax:
...
Navigate to your "Website Redesign" page. At the top, the **[[Concepts/Linked Task]]** widget shows all incomplete tasks from _other_ pages that link to this page — including the ones from your meeting notes.
