...
* **The index lives in the client.** It is built into IndexedDB in the browser ([[Architecture/ADR/007 Core Application Logic on the Client]], [[Architecture/ADR/001 Offline-First PWA]]) and maintained incrementally.
